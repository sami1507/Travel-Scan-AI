...
export const rankedDestinationSchema = z.object({
  ...
  destinationSummary: z.string().nullable().describe('Consultant-grade summary of the route'),
  diversityLabel: z.string().nullable().describe('Best Overall, Best Value, or Unique Discovery'),
